...
- [x] 1. Database schema and migrations
  ...
  - [x] 1.1 Extend jobs table for workshop functionality
  ...
  - [x] 1.2 Create equipment intake and status tables
  ...
  - [x] 1.4 Seed default workshop settings for existing companies
...
- [x] 2. TypeScript types and interfaces
  ...
  - [x] 2.1 Define workshop-related TypeScript types
...
- [x] 3. Workshop settings management





  - [x] 3.1 Create workshop settings controller
  ...
  - [x] 3.2 Create workshop settings routes
...
- [x] 4. Equipment intake management




  - [x] 4.1 Create intake service for business logic
  ...
  - [x] 4.2 Create intake controller
  ...
  - [x] 4.3 Implement intake photo upload
...
- [x] 5. Equipment status tracking





  - [x] 5.1 Create status service
  ...
  - [x] 5.2 Create status controller
...
- [x] 6. Workshop job management




  - [x] 6.1 Update job creation to support location type
  ...
  - [x] 6.2 Update job listing to filter by location type
  ...
  - [x] 6.3 Create workshop-specific job endpoints
...
- [x] 7. Workshop queue logic
  ...
  - [x] 7.2 Implement job claiming logic
...
- [x] 8. Return logistics management
  ...
  - [x] 8.1 Implement ready-for-pickup functionality
  ...
  - [x] 8.2 Implement delivery scheduling
  ...
  - [x] 8.3 Implement equipment return confirmation
  ...
  - [x] 8.4 Create return logistics routes
...
- [x] 9. Workshop notifications




  - [x] 9.1 Create workshop notification service
  ...
  - [x] 9.2 Integrate notifications with status changes
...
- [x] 10. Workshop metrics and reporting




  - [x] 10.1 Create metrics service
  ...
  - [x] 10.2 Create metrics endpoint
...
- [x] 11. Workshop capacity management




  - [x] 11.1 Implement capacity validation
  ...
  - [x] 11.2 Integrate capacity checks
...
- [x] 12. Admin frontend - Workshop queue page




  - [x] 12.1 Create workshop queue page
  ...
  - [x] 12.2 Implement queue actions
  ...
  - [x] 12.3 Create workshop API service
...
- [x] 13. Admin frontend - Equipment intake form





  - [x] 13.1 Create intake form component
  ...
  - [x] 13.2 Integrate intake form with job detail page
  ...
  - [x] 13.3 Create intake API service
...
- [x] 14. Admin frontend - Status tracking interface




  - [x] 14.1 Create status timeline component
  ...
  - [x] 14.2 Create status update component
  ...
  - [x] 14.3 Integrate status tracking with job detail page
  ...
  - [x] 14.4 Create status API service
...
- [x] 15. Admin frontend - Return logistics interface





  - [x] 15.1 Create return logistics component
  ...
  - [x] 15.2 Integrate return logistics with job detail page
...
- [x] 16. Admin frontend - Workshop settings page





  - [x] 16.1 Create workshop settings page
  ...
  - [x] 16.2 Implement settings save functionality
  ...
  - [x] 16.3 Create workshop settings API service
...
- [x] 17. Admin frontend - Workshop metrics dashboard





  - [x] 17.1 Create workshop metrics page
  ...
  - [x] 17.2 Create metrics API service
...
- [x] 18. Admin frontend - Job creation updates





  - [x] 18.1 Update work order creation form
...
- [x] 19. Customer portal - Equipment tracking




  - [x] 19.1 Create customer equipment tracking page
  ...
  - [x] 19.2 Add equipment tracking to customer dashboard
...
- [x] 20. Mobile app - Workshop job support




  - [x] 20.1 Update mobile job list to show location type
  ...
  - [x] 20.2 Create workshop queue view for mobile
  ...
  - [x] 20.3 Add status update functionality to mobile
...
- [x] 21. Integration and polish
  ...
  - [x] 21.1 Update navigation and routing
  ...
  - [x] 21.2 Add dashboard widgets for workshop
  ...
  - [x] 21.3 Update invoicing integration
  ...
  - [x] 21.4 Implement error handling and validation
